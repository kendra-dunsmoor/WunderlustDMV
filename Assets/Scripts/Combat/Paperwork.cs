...
public class Paperwork : MonoBehaviour
{
    ...
    [SerializeField] private string rejectDescription = "Send to <s>Limbo</s> Elysium";
    [SerializeField] private string acceptDescription = "Send to Elysium";
    ...
    public void CreatePaperwork(float enemyOdds)
    {
        ...
        if (RandomBool(enemyOdds))
        {
            ...
            textBox.text = acceptDescription;
        ...
        else
        {
            ...
            textBox.text = rejectDescription;
